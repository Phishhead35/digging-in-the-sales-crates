        ...
        <div style={{ position: 'relative', textAlign: 'center', maxWidth: 760 }}>
          ...
          <form onSubmit={handleSearch} style={{ maxWidth: 560, margin: '0 auto 32px' }}>
            <div style={{ position: 'relative', display: 'flex', gap: 0 }}>
              ...
              <button type="submit" style={{
                ...
                borderRadius: '0 12px 12px 0', color: '#000',
                fontWeight: 600, fontSize: 15, fontFamily: 'var(--font-body)',
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, justifyContent: 'center' }}>
            ...
            {TRENDING_SEARCHES.map(term => (
              <button key={term} onClick={() => handleTrending(term)} style={{
          ...
          {[
            {
              ...
              desc: 'Search Discogs and eBay simultaneously. One query, all the deals.',
              color: '#2ec4b6',
            },
            {
              icon: TrendingDown,
            ...
            <div key={title} style={{
              ...
              onMouseOver={e => { e.currentTarget.style.borderColor = color + '44'; e.currentTarget.style.transform = 'translateY(-4px)'; }}
